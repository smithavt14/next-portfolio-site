...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <div onAnimationEnd={(event) => endAnimation(event)} className="transition-all duration-200 fixed inset-x-0 top-0 p-6 md:p-12 lg:px-24 w-screen text-midnight dark:text-white flex justify-end items-center z-50 opacity-0 animate-fadeUp" style={{ animationDelay: '2s' }}>
