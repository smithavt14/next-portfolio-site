      ...
      <div className="w-full z-20 mb-32">
        ...
        <div className="my-8 flex justify-start items-center">
          <a className="mr-4 cursor-pointer" href="https://www.linkedin.com/in/smithavt14/" target="_blank" rel="noreferrer">
            <svg className="opacity-0 animate-fadeUp fill-midnight dark:fill-white hover:fill-slate-400 dark:hover:fill-slate-400 transition" style={{ animationDelay: '1.8s' }} viewBox="0 0 448 512" width="1.75rem" height="1.75rem">
          ...
          <a className="cursor-pointer mr-4" href="https://github.com/smithavt14" target="_blank" rel="noreferrer">
            <svg className="opacity-0 animate-fadeUp fill-midnight dark:fill-white hover:fill-slate-400 dark:hover:fill-slate-400 transition" style={{ animationDelay: '1.8s' }} viewBox="0 0 496 512" width="1.75rem" height="1.75rem">
          ...
          <a className="cursor-pointer" href="mailto:hello@alex.cn.com">
            <svg className="opacity-0 animate-fadeUp fill-midnight dark:fill-white hover:fill-slate-400 dark:hover:fill-slate-400 transition" style={{ animationDelay: '1.8s' }} viewBox="0 0 512 512" width="1.75rem" height="1.75rem">
