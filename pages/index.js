  ...
  return (
    <section
      ...
      <div className="font-extrabold text-responsive">
        <h2 className="text-midnight dark:text-white opacity-0 animate-fadeUp" style={{ animationDelay: '1.2s' }}>
          Alex Smith.
        </h2>
        <h2 className="text-slate-400 dark:text-slate-400 opacity-0 animate-fadeUp" style={{ animationDelay: '1.4s' }}>
          I build experiences.
        </h2>
      </div>
      <p className="w-full text-base text-midnight dark:text-white lg:w-8/12 opacity-0 animate-fadeUp" style={{ animationDelay: '1.6s' }}>
