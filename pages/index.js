...
export default function Home() {
  return (
    <div className="bg-midnight text-white relative">
      ...
      {/* Hero Section */}
      <div className="antialiased flex flex-col justify-center min-h-screen relative px-24 box-border">
        ...
        <Image src={mainBackground} layout='fill' objectPosition='bottom -140px left 0px' className="z-0 bg-midnight"/>
      </div>
    </div>
  )
}
